...
1. 将所有领域目录存储在`app`文件夹中
   1. `app/` - 应用的最高级别，包含通用模型、配置和常量等。
   2. `app/main.py` - 项目的根文件，用于初始化FastAPI应用
...
from app.posts.constants import ErrorCode as PostsErrorCode  # 以防每个包的constants模块中都有标准的ErrorCode
```
...
<img app="images/value_error_response.png" width="400" height="auto">
...
<img app="images/custom_responses.png" width="400" height="auto">
...
from app.database import database, posts, profiles, post_review, products
